...
window.addEventListener('DOMContentLoaded', () => {
    // FIX PATH PROTEKSI: Karena file html di root, tendang ke folder login jika tidak ada sesi
...
function inisialisasiSistemTampilanWarga(dataUser) {
    ...
    // Mengatur visibilitas menu log sampah tanpa menyentuh slogan teks statis header
    if (tipeAkun === 'PON') {
...
async function muatFotoProfilDinamis() {
    try {
        ...
        // FIX PATH: Menghilangkan ../ karena default-avatar.png sekarang satu level di root
    ...
    try {
        ...
        Object.keys(data).forEach(key => {
            ...
            if(i.warga_key === SESI_WARGA.key) {
                ...
                // FIX PATH: Menghilangkan ../ karena kuitansi.html sudah satu tingkat di root bersama dashboard
...
// FIX PATH LOGOUT: Buang seluruh data local storage lalu arahkan masuk ke folder login/
