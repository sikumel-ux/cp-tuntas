...
window.addEventListener('DOMContentLoaded', () => {
    ...
    // Perubahan nomor HP profil tanpa embel-embel +62
...
// Fungsi Pemicu Modal Pop-up Kuitansi Baru
    ...
    try {
        ...
        Object.keys(data).forEach(key => {
            ...
            if(i.warga_key === SESI_WARGA.key) {
                ...
                // Mengubah elemen link target_blank menjadi button dengan pemicu bukaModalKuitansi
